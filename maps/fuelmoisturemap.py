...
logging.basicConfig(filename='logs/fuelmoisturemap.log', level=logging.INFO)
logging.info(f"Fuel Moisture updated at {pd.Timestamp.now().strftime('%Y-%m-%d %H:%M CT')}")
